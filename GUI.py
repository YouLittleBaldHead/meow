...
et_stunum.place(x=80,y=8)
et_passwd.place(x=330,y=8)
et_ideco.place(x=660,y=8)
...
log_In=tk.Button(window,text='登录',font=('Arial',20),width=10,height=1,command=logIn).place(x=550,y=100)
